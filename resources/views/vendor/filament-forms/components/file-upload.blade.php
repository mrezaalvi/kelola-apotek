    ...
    >
        ...
        @if ($hasImageEditor && (! $isDisabled))
            ...
            >
                ...
                >
                    <div
                        class="mx-auto flex h-full w-full flex-col overflow-hidden bg-white ring-1 ring-gray-900/10 dark:bg-gray-800 dark:ring-gray-50/10 lg:flex-row"
                    >
                                        ...
                                        <div class="space-y-6 p-4">
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    ...
                                                    <label
                                                        class="flex w-full items-center border border-gray-300 bg-gray-100 text-sm shadow-sm dark:border-gray-700 dark:bg-gray-800"
                                                    >
                                                        <span
