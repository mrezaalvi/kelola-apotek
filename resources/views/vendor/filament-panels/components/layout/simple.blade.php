<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex min-h-screen items-center">
        ...
        <div class="fi-simple-main-ctn w-full">
            ...
            <main
                class="fi-simple-main mx-auto my-16 w-full bg-white px-6 py-12 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:max-w-lg sm:px-12"
            >
