    ...
    {{
        $attributes->class([
            ...
            match ($aside) {
                ...
                false => 'bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10',
            },
        ])
    }}
>
    ...
    >
        <div
            @class([
                'fi-section-content',
                'bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10' => $aside,
                match ($compact) {
                    true => 'p-4',
                    false => 'p-6',
                },
