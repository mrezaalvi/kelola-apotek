...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        'fi-icon-btn relative flex items-center justify-center outline-none transition duration-75 focus:ring-2 disabled:pointer-events-none disabled:opacity-70',
        match ($size) {
    ...
    $badgeClasses = 'absolute start-full top-0 z-10 -ms-1 -translate-x-1/2 bg-white dark:bg-gray-900';
